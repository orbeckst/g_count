 ...
 * \date   2002
 * $Id: g_zcoord.c,v 1.18 2008/01/14 15:14:05 oliver Exp $
 */
...
static char *SRCID_g_zoord_c = "$Id: g_zcoord.c,v 1.18 2008/01/14 15:14:05 oliver Exp $";
...
#define NDFILES 2
  ...
  static char *bugs[] = { 
    ...
    "compiles with Gromacs 3.3.1 but it is NOT TESTED: please send feedback to <oliver@biop.ox.ac.uk>"
  };
